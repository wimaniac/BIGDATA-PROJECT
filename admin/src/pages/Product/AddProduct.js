...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      productData.append("stock", 0); // Luôn đặt stock là 0
      ...
      alert("Tạo sản phẩm thành công, vui lòng tạo tồn kho cho sản phẩm!");
